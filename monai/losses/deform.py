...
class MembraneEnergyLoss(_Loss):
    """
    Calculate the membrane energy based on first-order differentiation of pred using central finite difference.

    Reference:
        Ashburner, John. 
        A fast diffeomorphic image registration algorithm.
        Neuroimage 38.1 (2007): 95-113.
    """
